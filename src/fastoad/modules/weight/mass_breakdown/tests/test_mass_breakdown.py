...
from ..a_airframe import EmpennageWeight, FlightControlsWeight, FuselageWeight, PaintWeight, \
    PylonsWeight, WingWeight, LandingGearWeight
from ..b_propulsion import FuelLinesWeight, UnconsumablesWeight, EngineWeight
from ..c_systems import FixedOperationalSystemsWeight, FlightKitWeight, LifeSupportSystemsWeight, \
    NavigationSystemsWeight, PowerSystemsWeight, TransmissionSystemsWeight
from ..cs25 import Loads
from ..d_furniture import CargoConfigurationWeight, PassengerSeatsWeight, FoodWaterWeight, \
...
def test_compute_loads():
    ...
    input_list = ['data:geometry:wing:area',
