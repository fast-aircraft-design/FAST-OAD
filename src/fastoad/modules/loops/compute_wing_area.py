...
class _ComputeWingArea(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('data:geometry:wing:area', val=10., units='m**2')
...
class _ComputeWingAreaConstraints(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('data:weight:aircraft:additional_fuel_capacity',
                              ['data:weight:aircraft:MFW', 'data:mission:sizing:fuel'],
                              method='fd')
        self.declare_partials('data:aerodynamics:aircraft:landing:additional_CL_capacity',
                              ['data:TLAR:approach_speed', 'data:weight:aircraft:MLW',
