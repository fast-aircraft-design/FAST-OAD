...
class ComputeOthersCG(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('cg_propulsion:B1', val=np.nan)
        self.add_input('cg_furniture:D2', val=np.nan)
        ...
        self.add_output('cg_airframe:A2')
        self.add_output('cg_airframe:A52')
        self.add_output('cg_airframe:A6')
        self.add_output('cg_airframe:A7')
        self.add_output('cg_propulsion:B2')
        self.add_output('cg_propulsion:B3')
        self.add_output('cg_systems:C11')
        self.add_output('cg_systems:C12')
        self.add_output('cg_systems:C13')
        self.add_output('cg_systems:C21')
        self.add_output('cg_systems:C22')
        self.add_output('cg_systems:C23')
        self.add_output('cg_systems:C24')
        self.add_output('cg_systems:C25')
        self.add_output('cg_systems:C26')
        self.add_output('cg_systems:C27')
        self.add_output('cg_systems:C3')
        self.add_output('cg_systems:C4')
        self.add_output('cg_systems:C51')
        self.add_output('cg_systems:C52')
        self.add_output('cg_furniture:D1')
        self.add_output('cg_furniture:D3')
        self.add_output('cg_furniture:D4')
        self.add_output('cg_furniture:D5')
        self.add_output('cg:cg_pax')
        self.add_output('cg:cg_rear_fret')
        self.add_output('cg:cg_front_fret')
