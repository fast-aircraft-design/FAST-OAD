...
class Loader:
    ...
    def framework(self) -> Framework:
        ...
        if FrameworkFactory.is_framework_running():
            ...
            if not self.__framework.get_bundle_context().get_service_reference(SERVICE_IPOPO):
    ...
    def get_services(self
        ...
        """
        references = self.get_service_references(service_name, properties, case_sensitive)
        services = None
