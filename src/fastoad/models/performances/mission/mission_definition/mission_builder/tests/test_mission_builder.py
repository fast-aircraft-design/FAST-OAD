...
def test_inputs(custom_segment_class):
    ...
    assert sorted(mission_builder.get_input_variables("sizing"), key=lambda v: v.name) == sorted(
        [
            ...
            Variable("data:aerodynamics:aircraft:high_speed:CD", val=np.nan, shape_by_conn=True),
            Variable("data:aerodynamics:aircraft:high_speed:CL", val=np.nan, shape_by_conn=True),
