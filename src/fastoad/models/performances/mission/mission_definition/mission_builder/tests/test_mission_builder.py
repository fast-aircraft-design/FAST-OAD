...
def test_inputs(custom_segment_class):
    ...
    assert sorted(mission_builder.get_input_variables("sizing"), key=lambda v: v.name) == sorted(
        [
            ...
            Variable("data:mission:sizing:taxi_out:thrust_rate", val=np.nan, units="unitless"),
            ...
            Variable("data:mission:sizing:taxi_in:thrust_rate", val=np.nan, units="unitless"),
            Variable("data:propulsion:initial_climb:thrust_rate", val=1.0, units="unitless"),
            Variable("data:propulsion:climb:thrust_rate", val=np.nan, units="unitless"),
            Variable("data:propulsion:descent:thrust_rate", val=np.nan, units="unitless"),
    ...
    assert set(mission_builder.get_input_variables("operational")) == {
        ...
        Variable("data:mission:operational:taxi_in:thrust_rate", val=np.nan, units="unitless"),
        Variable("data:mission:operational:taxi_out:duration", val=np.nan, units="s"),
        Variable("data:mission:operational:taxi_out:thrust_rate", val=np.nan, units="unitless"),
...
def test_build(custom_segment_class):
    ...
    inputs = {
        ...
        "data:aerodynamics:aircraft:high_speed:CD": cd,
        "data:aerodynamics:aircraft:high_speed:CL": cl,
                        ...
                        },
                        {
                            ...
                            "polar": {
                                "CD": InputDefinition(
                                    ...
                                    prefix="data:mission",
                                    use_opposite_=False,
                                    variable_name_="data:aerodynamics:aircraft:high_speed:CD",
                                ),
                                "CL": InputDefinition(
                                    parameter_name="CL",
                                    input_value=None,
                                    ...
                                    prefix="data:mission",
                                    use_opposite_=False,
                                    variable_name_="data:aerodynamics:aircraft:high_speed:CL",
                                ),
                                "name": "operational:main:climb",
                                "type": "polar",
                            },
