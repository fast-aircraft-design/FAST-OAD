...
def test_compute_wing_area():
    ...
    assert_allclose(problem['data:aerodynamics:aircraft:landing:additional_CL_capacity'], 0.199,
                    atol=1e-2)
    assert_allclose(problem['data:weight:aircraft:additional_fuel_capacity'], 500., atol=1.)
    ...
    assert_allclose(problem['data:aerodynamics:aircraft:landing:additional_CL_capacity'], 0.,
                    atol=1e-2)
    assert_allclose(problem['data:weight:aircraft:additional_fuel_capacity'], 6000., atol=1.)
