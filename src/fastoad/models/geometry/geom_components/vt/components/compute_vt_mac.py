...
class ComputeVTMAC(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('data:geometry:vertical_tail:MAC:length',
        ...
        self.declare_partials('data:geometry:vertical_tail:MAC:z',
                              ['data:geometry:vertical_tail:root_chord',
                               'data:geometry:vertical_tail:tip_chord',
                               'data:geometry:vertical_tail:span'], method='fd')
