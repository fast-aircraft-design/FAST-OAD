...
class ComputeSweepWing(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('data:geometry:wing:sweep_0',
                              ['data:geometry:wing:kink:leading_edge:x',
                               'data:geometry:wing:root:y',
                               'data:geometry:wing:kink:y'],
                              method='fd')
        self.declare_partials('data:geometry:wing:sweep_100_inner',
                              ['data:geometry:wing:kink:leading_edge:x',
                              ...
                              method='fd')
        self.declare_partials('data:geometry:wing:sweep_100_outer',
                              ['data:geometry:wing:kink:leading_edge:x',
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['data:geometry:wing:sweep_0'] = math.atan(
            x3_wing / (y3_wing - y2_wing)) / math.pi * 180.
