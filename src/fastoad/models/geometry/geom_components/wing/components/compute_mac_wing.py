...
class ComputeMACWing(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('data:geometry:wing:MAC:length',
                              ['data:geometry:wing:root:y', 'data:geometry:wing:kink:y',
                               'data:geometry:wing:tip:y', 'data:geometry:wing:root:chord',
                               'data:geometry:wing:kink:chord', 'data:geometry:wing:tip:chord',
                               'data:geometry:wing:area'], method='fd')
        self.declare_partials('data:geometry:wing:root:leading_edge:x',
                              ['data:geometry:wing:kink:leading_edge:x',
                               ...
                               'data:geometry:wing:kink:chord', 'data:geometry:wing:tip:chord',
                               'data:geometry:wing:area'], method='fd')
        self.declare_partials('data:geometry:wing:MAC:y',
                              ['data:geometry:wing:root:y', 'data:geometry:wing:kink:y',
                               'data:geometry:wing:tip:y', 'data:geometry:wing:root:chord',
                               'data:geometry:wing:kink:chord', 'data:geometry:wing:tip:chord',
                               'data:geometry:wing:area'], method='fd')
