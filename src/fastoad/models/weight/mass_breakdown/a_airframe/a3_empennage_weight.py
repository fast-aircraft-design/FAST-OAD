...
from fastoad.models.options import TAIL_TYPE_OPTION, ENGINE_LOCATION_OPTION
...
class EmpennageWeight(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('tuning:weight:airframe:horizontal_tail:mass:k', val=1.)
        self.add_input('tuning:weight:airframe:horizontal_tail:mass:offset', val=0., units='kg')
        self.add_input('tuning:weight:airframe:vertical_tail:mass:k', val=1.)
        self.add_input('tuning:weight:airframe:vertical_tail:mass:offset', val=0., units='kg')
