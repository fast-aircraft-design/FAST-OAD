...
def mass_breakdown(aircraft_xml: OMXmlIO):
    ...
    C25 = system['weight:systems:life_support:seats_crew_accomodation:mass'].value[0]
    ...
    h_tail = system['weight:airframe:tail_plane:horizontal:mass'].value[0]
    v_tail = system['weight:airframe:tail_plane:vertical:mass'].value[0]
