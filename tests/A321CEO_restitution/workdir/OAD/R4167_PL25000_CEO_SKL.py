...
The range and payload are updated respectively to 2250NM and 25000kg to compute the fuel for the new
weight variant. The wing span is increased to 35.8m to take into account of the sharklet addition.
"""
