...
def input_xml():
    return XPathReader(
        pth.join(pth.dirname(__file__), "data", "A320_baseline.xml"))
...
def test_evaluate_oew(input_xml):
    ivc = IndepVarComp()
    _add_outputs_for_oew(ivc, input_xml)
...
def test_loop_compute_oew(input_xml):
    ivc = IndepVarComp()
    _add_outputs_for_weight_loop(ivc, input_xml)
...
def _add_outputs_for_oew(ivc, input_xml):
    _add_outputs_base(ivc, input_xml)
...
def _add_outputs_for_weight_loop(ivc, input_xml):
    _add_outputs_base(ivc, input_xml)
    ivc.add_output('weight:Max_PL', input_xml.get_float('Aircraft/weight/Max_PL'), units='kg')


def _add_outputs_base(ivc, input_xml):
    [(lc1_u_gust, _)
        , (lc2_u_gust, _)] = input_xml.get_values_and_units(
        'Aircraft/weight/sizing_cases/SizingCase/U_gust')
    [(lc1_alt, _)
    ...
    ivc.add_output('cabin:front_seat_number_eco', val=input_xml.get_float(
        'Aircraft/cabin/eco/front_seat_number'))
    # Load cases ----------------------------------------------------------
    # self.add_output('geometry:wing_area', val=input_xml.get_float('Aircraft/geometry/wing/wing_area'))
    # self.add_output('geometry:wing_span', val=input_xml.get_float('Aircraft/geometry/wing/span'))
    # self.add_output('weight:MZFW',
    #                val=input_xml.get_float('Aircraft/weight/MZFW'))
    # self.add_output('weight:MFW', val=input_xml.get_float('Aircraft/weight/MFW'))
    # self.add_output('weight:MTOW', val=input_xml.get_float('Aircraft/weight/MTOW'))
    ...
    ivc.add_output('geometry:wing_toc_tip', val=input_xml.get_float(
        'Aircraft/geometry/wing/toc/tip'))
    # self.add_output('geometry:wing_l2', val=input_xml.get_float('Aircraft/geometry/wing/l2_wing'))
    ...
    ivc.add_output('kfactors_a1:K_mvo', val=input_xml.get_float(
        'Aircraft/weight/k_factors/Wing_A1/K_mvo'))
    # Fuselage Weight -----------------------------------------------------
    # self.add_output('n1m1', val=241000,  # output from load computation is expected to be slightly different
    ivc.add_output('geometry:fuselage_wet_area', input_xml.get_float(
        'Aircraft/geometry/fuselage/S_mbf'), units='m**2')
    # self.add_output('geometry:fuselage_width_max', val=input_xml.get_float('Aircraft/geometry/fuselage/width_max'))
    # self.add_output('geometry:fuselage_height_max', val=input_xml.get_float('Aircraft/geometry/fuselage/height_max'))
    ...
    ivc.add_output('geometry:ht_area',
                   val=input_xml.get_float('Aircraft/geometry/ht/area'), units='m**2')
    ivc.add_output('geometry:vt_area',
                   val=input_xml.get_float('Aircraft/geometry/vt/area'), units='m**2')
    ...
    # self.add_output('geometry:wing_b_50', val=input_xml.get_float('Aircraft/geometry/wing/b_50'))
    ...
    # self.add_output('geometry:engine_number', val=input_xml.get_float('Aircraft/geometry/propulsion/engine_number'))
    # self.add_output('weight_propulsion:B1', val=input_xml.get_float('Aircraft/weight/propulsion/weight_B1'))
    ...
    ivc.add_output('geometry:S_total',
                   val=input_xml.get_float('Aircraft/geometry/S_total'), units='m**2')
    ...
    ivc.add_output('propulsion_conventional:thrust_SL',
                   val=input_xml.get_float(
                       'Aircraft/propulsion/conventional/thrust_SL'), units='lbf')
    # self.add_output('geometry:engine_number', val=input_xml.get_float('Aircraft/geometry/propulsion/engine_number'))
    ...
    # Power Systems Weight ------------------------------------------------
    # self.add_output('cabin:NPAX1', val=150,  # input_xml.get_float('Aircraft/cabin/NPAX1'))
    # self.add_output('weight_airframe:A4', val=700,
    # 'weight:MTOW': input_xml.get_float('Aircraft/weight/MTOW'))
    ...
    # self.add_output('geometry:engine_number', val=input_xml.get_float('Aircraft/geometry/propulsion/engine_number'))
    # self.add_output('cabin:NPAX1', val=150,  # input_xml.get_float('Aircraft/cabin/NPAX1'))
    # self.add_output('cabin:PNT', val=input_xml.get_float('Aircraft/cabin/PNT'))
    # self.add_output('cabin:PNC', val=input_xml.get_float('Aircraft/cabin/PNC'))
    # self.add_output('geometry:wing_span', val=input_xml.get_float('Aircraft/geometry/wing/span'))
    # self.add_output('weight_propulsion:B1', val=input_xml.get_float('Aircraft/weight/propulsion/weight_B1'))
    ...
    # self.add_output('geometry:fuselage_length', val=input_xml.get_float('Aircraft/geometry/fuselage/fus_length'))
    # self.add_output('geometry:wing_b_50', val=input_xml.get_float('Aircraft/geometry/wing/b_50'))
    ivc.add_output('kfactors_c3:K_C3', val=input_xml.get_float(
        'Aircraft/weight/k_factors/instrument_navigation_C3/C3/k'))
    ivc.add_output('kfactors_c3:offset_C3', val=input_xml.get_float(
        'Aircraft/weight/k_factors/instrument_navigation_C3/C3/offset'), units='kg')
    ...
    # self.add_output('geometry:fuselage_length', val=input_xml.get_float('Aircraft/geometry/fuselage/fus_length'))
    # self.add_output('cabin:front_seat_number_eco', val=input_xml.get_float('Aircraft/cabin/eco/front_seat_number'))
    # self.add_output('geometry:wing_l2', val=input_xml.get_float('Aircraft/geometry/wing/l2_wing'))
    ...
    # self.add_output('tlar:NPAX', val=input_xml.get_float('Aircraft/TLAR/NPAX'))
