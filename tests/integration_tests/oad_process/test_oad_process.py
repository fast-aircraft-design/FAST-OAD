...
def test_api(cleanup):
    ...
    assert_allclose(problem["data:weight:aircraft:MTOW"], 77200, atol=5)
    assert_allclose(problem["data:geometry:wing:area"], 130.4, atol=1e-1)
    assert_allclose(problem["data:geometry:vertical_tail:area"], 28.1, atol=1e-1)
