...
def test_get_system(framework_load_unload):
    ...
    assert OpenMDAOSystemRegistry.get_system_domain('sellar.disc1').value == ModelDomain.OTHER.value
    assert OpenMDAOSystemRegistry.get_system_domain(
        disc1_component).value == ModelDomain.OTHER.value
    ...
    assert OpenMDAOSystemRegistry.get_system_domain(
        'sellar.disc2').value == ModelDomain.UNSPECIFIED.value
    assert OpenMDAOSystemRegistry.get_system_domain(
        disc2_component).value == ModelDomain.UNSPECIFIED.value
